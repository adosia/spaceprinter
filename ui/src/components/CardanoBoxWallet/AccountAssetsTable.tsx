                    ...
                    row.meta.onchain_metadata.files.map( (file: any, key: any) => {
                      return(
                        <>
                          ...
                          { file.mediaType == "model/stl" && <STLDialog fileUrl={`https://ipfs.io/ipfs/${file.src.replace("ipfs://","")}` } fileName={hex2a(row.meta.asset_name)} stlName={file.name ? file.name : hex2a(row.meta.asset_name)} color={file.color ? file.color : "green"} type="stl" />  }
