...
import { makeStyles, useTheme, Theme, createStyles, Typography, Toolbar, IconButton, Hidden, Drawer, Divider, AppBar, Button, Tooltip } from '@material-ui/core';
...
const ResponsiveDrawer:React.FC<DrawerProps> = ({ window, pageName }) => {
