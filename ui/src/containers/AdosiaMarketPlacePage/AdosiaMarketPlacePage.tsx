...
import { AdosiaMarketPlace } from "../../components/SpacePrinter/AdosiaMarketPlace";
import AppDrawer2 from "../../components/NavBar/AppDrawer2";
import "./AdosiaMarketPlacePage.css";

const AdosiaMarketPlacePage: React.FC = () => {
...
export default AdosiaMarketPlacePage;
