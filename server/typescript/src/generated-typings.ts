 ...
 *
 */
export type  = UserName | Password | SessionType | JwToken | WalletName | SeedPhrase | WalletPassPhrase | WalletType | WalletID | AccountName | Utxos | Assets | Metadata | Outputs | ChangeAddress | TxTTL | Configjson | Gcode | FileURL | FileName | UpdateType | Hostname | WifiAction | Ssid | SsidPass | StringDoaGddGA;
...
export type GenGruntTX = (jwToken: JwToken, walletID: WalletID, walletPassPhrase: WalletPassPhrase, accountName: AccountName, utxos: Utxos, assets: Assets, metadata: Metadata, outputs: Outputs, changeAddress: ChangeAddress, txTTL: TxTTL) => Promise<StringDoaGddGA>;
