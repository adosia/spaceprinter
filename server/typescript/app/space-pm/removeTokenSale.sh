...
token_sale_to_cancel="${customer_address} + ${min_utxo} + ${asset}"

echo -e "\nCanceling A Token Sale:\n" ${token_sale_to_cancel}
...
FEE=$(${cli} transaction build \
    ...
    --tx-in-redeemer-file data/redeemer7.json \
    --tx-out="${token_sale_to_cancel}" \
