...
asset2="1 385a4b10e2aa436462dc70152601ab59043c2ae016dd193f3be8685c.Poopdoopydo009"

min_utxo=$(${cli} transaction calculate-min-required-utxo \
    --protocol-params-file tmp/protocol.json \
    --tx-out="${script_address} ${asset2}" | tr -dc '0-9') 
    
customer_job_to_be_printed="${script_address} + ${min_utxo} + ${asset2}"
